      ...
      <StyledNavbar className={navBarVisible ? "active" : ""}>
        ...
        <ul>
          ...
          <li>
            <NavbarItem>
          <a
            href="https://drive.google.com/file/d/1g4lpv657OVCv6lltDFuNJ42Dre9F-8m-/view?usp=drive_link"
            className="navbar-item"
            style={{color: "#fff4",fontSize:"'Roboto Mono', monospace", fontWeight: "semibold", text: "2.369rem"}}
            >
            Resume
          </a>
            </NavbarItem>
